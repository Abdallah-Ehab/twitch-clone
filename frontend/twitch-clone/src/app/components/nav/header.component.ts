        ...
        <div class="flex items-center gap-2 ml-auto">
          ...
          @if (!userService.isLoggedIn()) {
            ...
            <div class="hidden md:flex items-center gap-4">
              <span class="text-sm font-medium text-foreground">Hello, {{ userService.currentUser()?.username }}</span>
              <a href="/dashboard" brnButton variant="outline" class="text-sm font-medium bg-secondary p-2 rounded hover:bg-secondary/80">Dashboard</a>
            </div>
            <div class="relative">
